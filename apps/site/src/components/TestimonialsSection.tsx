...
export function TestimonialsSection() {
  ...
  // Diferente das outras seções, esta nunca some por completo mesmo sem
  // depoimentos publicados — o formulário de avaliação precisa continuar
  // visível pra receber os primeiros envios.
  return (
      ...
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
        ...
        {!loading && testimonials.length === 0 && (
          <p className="mt-8 text-sm text-ink-muted">
            Ainda não temos avaliações publicadas — que tal deixar a primeira? 👇
          </p>
        )}
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          onClick={() => trackEvent('whatsapp_click', { model: null, source: 'depoimentos' })}
